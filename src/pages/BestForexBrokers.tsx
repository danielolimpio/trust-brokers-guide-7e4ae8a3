...
export default function BestForexBrokers() {
  ...
  return (
    <div className="min-h-screen">
      <SEO
        title="Best Forex Brokers 2025 – Top Rated & Most Trusted"
        description="Discover the best forex brokers in 2025. Compare top-rated, regulated brokers with verified safety checks, competitive spreads, and excellent trading conditions."
        canonical="https://brokertrusted.com/best-forex-brokers"
        keywords={["best forex brokers","top forex brokers 2025","most trusted brokers","forex broker rankings"]}
      />
      <Header />
      <main>
